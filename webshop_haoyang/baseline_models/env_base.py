...
from web_agent_site.envs import WebAgentTextEnvBase
...
class WebEnv:
    ...
    def __init__(self, args, split, server=None, id=None, feat_conv=None):
        self.env = WebAgentTextEnvBase(observation_mode=args.state_format, server=server,
