...
from env_base import WebEnv  # TODO: just use webshopEnv?
import torch
...
args = webenv_args()[0]
env = WebEnv(args, split='test', feat_conv=feat_conv)
print('env loaded')
...
if __name__ == "__main__":
    ...
    if args.model_name == "bert-base":
        ...
        config = FlanT5ConfigForWebshop(image=args.image, pretrain_bert=1)
