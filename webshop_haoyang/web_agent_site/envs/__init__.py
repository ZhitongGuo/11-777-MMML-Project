...
from web_agent_site.envs.web_agent_text_env import WebAgentTextEnv, WebAgentTextEnvBase
...
register(
  id='WebAgentTextEnvBase-v0',
  entry_point='web_agent_site.envs:WebAgentTextEnvBase',
)